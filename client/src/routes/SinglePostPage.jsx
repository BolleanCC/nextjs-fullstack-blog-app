      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          ...
          <p className="text-gray-500 font-medium">
            ...
            magnam placeat necessitatibus soluta ipsam consectetur repellendus,
            optio praesentium voluptatum iusto omnis dolor tempore numquam quas
            obcaecati odit, aliquam rerum quo.
          </p>
        </div>
